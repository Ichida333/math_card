\begin{proof} $\varphi (n) :A \subseteq n \rightarrow ((\Card{A}=C_A(n) \leq n) \land (\BijectionMap{C_A\restriction_{{A}}}{A}{\Card{A}})
 ...
 (base step) $\varphi (0) \Leftrightarrow A \subseteq 0 \rightarrow ((\Card{A}=C_A(0) \leq 0) \land (\BijectionMap{\seigen{C_A}{A}}{A}{\Card{A}})
...
$\forall n\in\nat ((A \subseteq n \rightarrow ((\Card{A} = C_A(n) \leq n) \land (\BijectionMap{\seigen{C_A}{A}}{A}{\Card{A}})
\land (C_A(n) = n \rightarrow A=n))) \\
 \rightarrow (A \subseteq n+1 \rightarrow ((\Card{A}=C_{A}(n+1) \leq n+1) \land (\BijectionMap{\seigen{C_A}{A}}{A}{\Card{A}})
