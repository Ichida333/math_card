...
$\forall n\in\mathbb{N} ((A \subseteq n \rightarrow ((\operatorname{Card}(A)=C_A(n) \leq n) \land (\BijectionMap{C_A\restriction_{{A}}}{A}{\operatorname{Card}(A)})
 \land (C_A(n) = n \rightarrow A=n))) \\
 \rightarrow (A \subseteq n+1 \rightarrow ((\operatorname{Card}(A)=C_A(n+1) \leq n+1) \land (\BijectionMap{C_A\restriction_{{A}}}{A}{\operatorname{Card}(A)})
 \land (C_A(n+1) = n+1 \rightarrow A=n+1))))$
\end{proof}
