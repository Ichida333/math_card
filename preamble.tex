...
\newcommand{\InjMap}[3]{#1\colon #2 \xrightarrow{\text{inj}} #3}
\newcommand{\SurjectionMap}[3]{#1\colon #2 \xrightarrow{\text{sur}} #3}
\newcommand{\SurMap}[3]{#1\colon #2 \xrightarrow{\text{sur}} #3}
\newcommand{\BijectionMap}[3]{#1\colon #2 \xrightarrow{\text{bij}} #3}
\newcommand{\BijMap}[3]{#1\colon #2 \xrightarrow{\text{bij}} #3}
